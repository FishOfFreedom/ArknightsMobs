...
public class Parabola {
    ...
    public void mathParabola(LivingEntity patriot, LivingEntity target){
        double x1 = 0.001;
        double y1 = 0.001;
        this.x = target.getPosX() - patriot.getPosX();
        this.z = target.getPosZ() - patriot.getPosZ();
        this.x2 = Math.sqrt(x*x+z*z);
        double y2 = target.getPosY() - patriot.getPosY();
        double x3 = x2/2;
        double y3 = 60;
        double[][] matrix = {
                {x1 * x1, x1, 1},
    ...
    public void mathParabola(LivingEntity patriot, Vector3f targetPos){
        double x1 = 0.001;
        double y1 = 0.001;
        this.x = targetPos.getX() - patriot.getPosX();
        this.z = targetPos.getZ() - patriot.getPosZ();
        this.x2 = Math.sqrt(x*x+z*z);
        double y2 = targetPos.getY() - patriot.getPosY();
        double x3 = x2/2;
        double y3 = 60;
        double[][] matrix = {
                {x1 * x1, x1, 1},
