...
//            particleAlpha = ((float)age/(float)maxAge);
    ...
    public static final class OrbFactory implements IParticleFactory<OrbData> {
        ...
        @Override
        public Particle makeParticle(OrbData typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static class OrbData implements IParticleData {
        public static final IDeserializer<OrbData> DESERIALIZER = new IDeserializer<OrbData>() {
