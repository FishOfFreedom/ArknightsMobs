...
public class ProtectionVillager extends TargetGoal {
    private final GuerrillasEntity irongolem;
    ...
    public ProtectionVillager(GuerrillasEntity ironGolemIn) {
    ...
    public void startExecuting() {
        if(irongolem instanceof Patriot){
            Patriot patriot = (Patriot) irongolem;
            patriot.attackMode = Patriot.AttackMode.ENTITY;
        }
